...
if ( ! function_exists('b4st_enqueues') ) {
	function b4st_enqueues() {
		...
		wp_register_style('custom-css', get_template_directory_uri() . '/__inc/css/custom.css', false, null);
		...
		wp_register_script('custom-js', get_template_directory_uri() . '/__inc/js/custom.js', false, null, true);
